...
static const struct midr_range arm64_bp_harden_qcom_cpus[] = {
...
static bool is_spectrev2_safe(void)
{
	...
	return !is_midr_in_range_list(midr, arm64_bp_harden_smccc_cpus) &&
	       !is_midr_in_range_list(midr, arm64_bp_harden_qcom_cpus);
}
