...
#define V4L2_DV_BT_CEA_640X480P59_94 { \
	...
	V4L2_INIT_BT_TIMINGS(640, 480, 0, 0, \
		...
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 1 }) \
}
...
#define V4L2_DV_BT_CEA_720X480I59_94 { \
	...
	V4L2_INIT_BT_TIMINGS(720, 480, 1, 0, \
		...
		{ .picture_aspect = { 4, 3 }, .cea861_vic = 6 }) \
}
...
#define V4L2_DV_BT_CEA_720X480P59_94 { \
	...
	V4L2_INIT_BT_TIMINGS(720, 480, 0, 0, \
		...
		V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 4, 3 }, .cea861_vic = 2 }) \
}
...
#define V4L2_DV_BT_CEA_720X576I50 { \
	...
	V4L2_INIT_BT_TIMINGS(720, 576, 1, 0, \
		...
		V4L2_DV_FL_HALF_LINE | V4L2_DV_FL_IS_CE_VIDEO | \
		V4L2_DV_FL_HAS_PICTURE_ASPECT | V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 4, 3 }, .cea861_vic = 21 }) \
}
...
#define V4L2_DV_BT_CEA_720X576P50 { \
	...
	V4L2_INIT_BT_TIMINGS(720, 576, 0, 0, \
		...
		V4L2_DV_FL_IS_CE_VIDEO | V4L2_DV_FL_HAS_PICTURE_ASPECT | \
		V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 4, 3 }, .cea861_vic = 17 }) \
}
...
#define V4L2_DV_BT_CEA_1280X720P24 { \
	...
	V4L2_INIT_BT_TIMINGS(1280, 720, 0, \
		...
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 60 }) \
}
...
#define V4L2_DV_BT_CEA_1280X720P25 { \
	...
	V4L2_INIT_BT_TIMINGS(1280, 720, 0, \
		...
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 61 }) \
}
...
#define V4L2_DV_BT_CEA_1280X720P30 { \
	...
	V4L2_INIT_BT_TIMINGS(1280, 720, 0, \
		...
		V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 62 }) \
}
...
#define V4L2_DV_BT_CEA_1280X720P50 { \
	...
	V4L2_INIT_BT_TIMINGS(1280, 720, 0, \
		...
		V4L2_DV_BT_STD_CEA861, \
		V4L2_DV_FL_IS_CE_VIDEO | V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 19 }) \
}
...
#define V4L2_DV_BT_CEA_1280X720P60 { \
	...
	V4L2_INIT_BT_TIMINGS(1280, 720, 0, \
		...
		V4L2_DV_FL_CAN_REDUCE_FPS | V4L2_DV_FL_IS_CE_VIDEO | \
		V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 4 }) \
}
...
#define V4L2_DV_BT_CEA_1920X1080P24 { \
	...
	V4L2_INIT_BT_TIMINGS(1920, 1080, 0, \
		...
		V4L2_DV_FL_CAN_REDUCE_FPS | V4L2_DV_FL_IS_CE_VIDEO | \
		V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 32 }) \
}
...
#define V4L2_DV_BT_CEA_1920X1080P25 { \
	...
	V4L2_INIT_BT_TIMINGS(1920, 1080, 0, \
		...
		V4L2_DV_BT_STD_CEA861, \
		V4L2_DV_FL_IS_CE_VIDEO | V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 33 }) \
}
...
#define V4L2_DV_BT_CEA_1920X1080P30 { \
	...
	V4L2_INIT_BT_TIMINGS(1920, 1080, 0, \
		...
		V4L2_DV_FL_CAN_REDUCE_FPS | V4L2_DV_FL_IS_CE_VIDEO | \
		V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 34 }) \
}
...
#define V4L2_DV_BT_CEA_1920X1080I50 { \
	...
	V4L2_INIT_BT_TIMINGS(1920, 1080, 1, \
		...
		V4L2_DV_FL_HALF_LINE | V4L2_DV_FL_IS_CE_VIDEO | \
		V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 20 }) \
}
...
#define V4L2_DV_BT_CEA_1920X1080P50 { \
	...
	V4L2_INIT_BT_TIMINGS(1920, 1080, 0, \
		...
		V4L2_DV_BT_STD_CEA861, \
		V4L2_DV_FL_IS_CE_VIDEO | V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 31 }) \
}
...
#define V4L2_DV_BT_CEA_1920X1080I60 { \
	...
	V4L2_INIT_BT_TIMINGS(1920, 1080, 1, \
		...
		V4L2_DV_FL_HALF_LINE | V4L2_DV_FL_IS_CE_VIDEO | \
		V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 5 }) \
}
...
#define V4L2_DV_BT_CEA_1920X1080P60 { \
	...
	V4L2_INIT_BT_TIMINGS(1920, 1080, 0, \
		...
		V4L2_DV_FL_CAN_REDUCE_FPS | V4L2_DV_FL_IS_CE_VIDEO | \
		V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 16 }) \
}
...
#define V4L2_DV_BT_CEA_3840X2160P24 { \
	...
	V4L2_INIT_BT_TIMINGS(3840, 2160, 0, \
		...
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 93, \
		  .hdmi_vic = 3 }) \
}
...
#define V4L2_DV_BT_CEA_3840X2160P25 { \
	...
	V4L2_INIT_BT_TIMINGS(3840, 2160, 0, \
		...
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 94, \
		  .hdmi_vic = 2 }) \
}
...
#define V4L2_DV_BT_CEA_3840X2160P30 { \
	...
	V4L2_INIT_BT_TIMINGS(3840, 2160, 0, \
		...
		V4L2_DV_FL_CAN_REDUCE_FPS | V4L2_DV_FL_IS_CE_VIDEO | \
		V4L2_DV_FL_HAS_CEA861_VIC | V4L2_DV_FL_HAS_HDMI_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 95, \
		  .hdmi_vic = 1 }) \
}
...
#define V4L2_DV_BT_CEA_3840X2160P50 { \
	...
	V4L2_INIT_BT_TIMINGS(3840, 2160, 0, \
		...
		V4L2_DV_BT_STD_CEA861, \
		V4L2_DV_FL_IS_CE_VIDEO | V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 96 }) \
}
...
#define V4L2_DV_BT_CEA_3840X2160P60 { \
	...
	V4L2_INIT_BT_TIMINGS(3840, 2160, 0, \
		...
		V4L2_DV_FL_CAN_REDUCE_FPS | V4L2_DV_FL_IS_CE_VIDEO | \
		V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 97 }) \
}
...
#define V4L2_DV_BT_CEA_4096X2160P24 { \
	...
	V4L2_INIT_BT_TIMINGS(4096, 2160, 0, \
		...
		V4L2_DV_FL_CAN_REDUCE_FPS | V4L2_DV_FL_IS_CE_VIDEO | \
		V4L2_DV_FL_HAS_CEA861_VIC | V4L2_DV_FL_HAS_HDMI_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 98, \
		  .hdmi_vic = 4 }) \
}
...
#define V4L2_DV_BT_CEA_4096X2160P25 { \
	...
	V4L2_INIT_BT_TIMINGS(4096, 2160, 0, \
		...
		V4L2_DV_BT_STD_CEA861, \
		V4L2_DV_FL_IS_CE_VIDEO | V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 99 }) \
}
...
#define V4L2_DV_BT_CEA_4096X2160P30 { \
	...
	V4L2_INIT_BT_TIMINGS(4096, 2160, 0, \
		...
		V4L2_DV_FL_CAN_REDUCE_FPS | V4L2_DV_FL_IS_CE_VIDEO | \
		V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 100 }) \
}
...
#define V4L2_DV_BT_CEA_4096X2160P50 { \
	...
	V4L2_INIT_BT_TIMINGS(4096, 2160, 0, \
		...
		V4L2_DV_BT_STD_CEA861, \
		V4L2_DV_FL_IS_CE_VIDEO | V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 101 }) \
}
...
#define V4L2_DV_BT_CEA_4096X2160P60 { \
	...
	V4L2_INIT_BT_TIMINGS(4096, 2160, 0, \
		...
		V4L2_DV_FL_CAN_REDUCE_FPS | V4L2_DV_FL_IS_CE_VIDEO | \
		V4L2_DV_FL_HAS_CEA861_VIC, \
		{ .picture_aspect = { 0, 0 }, .cea861_vic = 102 }) \
}
