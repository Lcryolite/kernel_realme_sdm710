...
#define BPF_XADD	BPF_ATOMIC	/* exclusive add - legacy name */
...
#define BPF_FETCH	0x01	/* fetch the value before the operation */
...
/* Sleepable programs may call helpers that are safe in a sleepable context. */
