...
enum bpf_arg_type {
	...
	ARG_PTR_TO_RDONLY_MEM, /* pointer to initialized memory, including kernel BTF memory */
	...
	ARG_PTR_TO_CONST_STR,	/* pointer to a NUL-terminated string in a read-only map */
};
...
enum bpf_return_type {
	...
	RET_PTR_TO_BTF_ID,		/* returns a pointer to a kernel BTF type */
};
...
struct bpf_func_proto {
	...
	const char *ret_btf_id_name; /* kernel BTF struct name for return value */
};
...
/*
 * Socket-address programs use bit 0 as their allow result and return
 * attach-type flags in the upper bits.
 */
