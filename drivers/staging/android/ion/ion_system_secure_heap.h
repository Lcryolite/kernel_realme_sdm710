...
int ion_system_secure_heap_prefetch_legacy(struct ion_heap *heap, void *data);
int ion_system_secure_heap_drain_legacy(struct ion_heap *heap, void *data);
int ion_secure_cma_prefetch(struct ion_heap *heap, void *data);
int ion_secure_cma_drain_pool(struct ion_heap *heap, void *data);
...
int ion_system_secure_heap_prefetch_compat(struct ion_heap *heap, void *data);
int ion_system_secure_heap_drain_compat(struct ion_heap *heap, void *data);
#endif
