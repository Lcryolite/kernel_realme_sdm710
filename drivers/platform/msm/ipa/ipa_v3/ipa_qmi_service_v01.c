...
/*
 * The RMX1901 userspace ABI stores the two 16-bit QMI response values in
 * 32-bit enum slots.  Keep the wire width at 16 bits while decoding into the
 * legacy in-memory offsets.
 */
static struct qmi_elem_info ipa3_legacy_qmi_response_type_v01_ei[] = {
	{
...
#define qmi_response_type_v01 ipa_qmi_response_type_v01
#define qmi_response_type_v01_ei ipa3_legacy_qmi_response_type_v01_ei
...
#ifdef IPA_QMI_ENABLE_POST_RMX1901_FIELDS
	{
		.data_type	= QMI_OPT_FLAG,
		.elem_len	= 1,
		.elem_size	= sizeof(u8),
